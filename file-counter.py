...
def main():
    ...
    parser.add_argument('--input', help="input file of video still frames", required=True)
    parser.add_argument('--output', help="output file of annotated frames", required=True)
